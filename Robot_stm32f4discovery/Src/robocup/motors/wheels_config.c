...
#elif defined (GAMMA2)
{"wheel 1", {0}, EncoderTim1, &htim5, TIM_CHANNEL_1, MOTOR1_DIR_GPIO_Port, MOTOR1_DIR_Pin, ClockWise, M_PI_4,          1.0},
{"wheel 2", {0}, EncoderTim2, &htim8, TIM_CHANNEL_3, MOTOR2_DIR_GPIO_Port, MOTOR2_DIR_Pin, ClockWise, M_PI_2 + M_PI_4, 1.0},
{"wheel 3", {0}, EncoderTim3, &htim5, TIM_CHANNEL_3, MOTOR3_DIR_GPIO_Port, MOTOR3_DIR_Pin, ClockWise, -M_PI_2 -M_PI_4, 1.0},
{"wheel 4", {0}, EncoderTim4, &htim5, TIM_CHANNEL_4, MOTOR4_DIR_GPIO_Port, MOTOR4_DIR_Pin, ClockWise, -M_PI_4,         1.0}
#endif
};
